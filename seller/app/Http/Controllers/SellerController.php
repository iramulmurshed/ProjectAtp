...
//
//
//        $Seller->p_name=$request->p_name;
//
//        $Seller->p_id=$request->p_id;
//        $Seller->p_type=$request->p_type;
//        $Seller->p_des=$request->p_des;
//        $Seller->p_price=$request->p_price;
//        $Seller->s_status="available";
//
//        $Seller->save();
